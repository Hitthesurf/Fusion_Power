...
\end{equation}
In the integral over $\Gamma_D$ in (\ref{}) $u$ can be replaced with $0$. This is included in the formula to show how one would calculate the problem with non zero boundary conditions.
...
The paper \cite{LINE_INT} states we can use line integration to solve PDE (\ref{PDE}).  to The idea of line integration is to reduce the dimension 
