...
\end{equation}
We will cover three sub-examples with $(\alpha=0),(\alpha=2,m=1)$ and $(\alpha = 2, m=10)$. Thus we get electromagnetic fields  
\begin{figure}[H]
 \begin{subfigure}{0.60\textwidth}
\lstinputlisting[language=c++]{Code_Snippits/ExamplePPM.ppm}
     \caption{.PPM file for Figure \ref{PPMOutput}}
     \label{PPMExampleFile}
 \end{subfigure}
 \hfill
 \begin{subfigure}{0.39\textwidth}
     \includegraphics[width=\textwidth]{Pics/Code/ExamplePPM.png}
     \caption{Visual output of .PPM file}
     \label{PPMOutput}
 \end{subfigure}
  \hfill
 \caption{.PPM file text with visual output} \label{PPM_Example}
\end{figure}
