...
\lstinputlisting[language=Python]{CodeSnips/SP.py}
...
\lstinputlisting[language=Python]{CodeSnips/LM.py}
...
\lstinputlisting[language=Python]{CodeSnips/MMAP.py}
...
\lstinputlisting[language=Python]{CodeSnips/LM_STAB.py}
...
\end{cases}
\end{equation}
where we solve for trial functions $(u,q) \in \mathcal{V} \times \mathcal{V}$ with test functions $(\hat{u}, \hat{q}) \in \mathcal{V} \times \mathcal{V}$. The code is similar to the $(LM_STAB)$ method in section \ref{LM_STAB} but $F$ is defined as
\lstinputlisting[language=Python]{CodeSnips/MMAP_STAB.py}
